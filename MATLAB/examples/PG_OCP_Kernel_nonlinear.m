...
n_phi = 4; % number of basis functions
...
PG_samples = load("PGibbs_Samples_K200_nonlinear.mat");
PG_samples = PG_samples.PG_samples;
...
[U_scenario, X_scenario, Y_scenario] = Solve_OCP_Scenario_Constraints_casadi(PG_samples, x_vec_0, v_vec, e_vec, H, K_opt, phi, g, n_x, n_y, n_u, y_min, y_max);
...
[U_casadi, X_casadi, Y_casadi] = Solve_OCP_Kernel_maxConstraint_casadi(PG_samples, x_vec_0, v_vec, e_vec, H, K_opt, phi, g, n_x, n_y, n_u, y_min, y_max, alpha, sigma_mult, U_scenario);
